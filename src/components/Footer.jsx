          ...
          <div className="flex flex-col items-center md:items-end gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="https://x.com/InfinityAcade11" target="_blank" rel="noreferrer"
                ...
                className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 hover:text-white hover:border-white/40 hover:bg-white/10 transition-all">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://clpamy.page.link/YPQc" target="_blank" rel="noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-[#34A853]/15 border border-white/10 hover:border-[#34A853]/35 rounded-xl text-white text-xs font-bold transition-all shadow-md">
              <svg className="w-4 h-4 text-[#34A853]" fill="currentColor" viewBox="0 0 24 24">
                <path d="M3.609 1.814L13.783 12 3.609 22.186c-.18.18-.329.124-.329-.13V1.943c0-.253.15-.31.329-.129zm10.886 9.475l2.796-2.795 3.39 1.962c.904.523.904 1.378 0 1.901l-3.39 1.962-2.796-2.795c-.179-.179-.179-.47 0-.649zM4.604 1.054L13.43 9.88l3.655-3.655L4.856.76c-.18-.104-.383.029-.252.294zm8.826 13.066l-8.826 8.826c-.131.265.072.398.252.294l3.655-3.655 4.919 4.919z"/>
              </svg>
              Practice Online Tests / ऑनलाईन टेस्ट
            </a>
          </div>
        </div>
