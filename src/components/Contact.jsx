          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <a href="https://t.me/infinityacademy121212" target="_blank" rel="noreferrer"
                ...
                className="flex items-center justify-center gap-2 p-4 rounded-xl bg-blue-50 border border-blue-200 text-blue-700 font-bold text-sm hover:bg-blue-100 hover:scale-105 transition-all duration-300">
              ...
              <a href="https://www.instagram.com/infinity_career_academy" target="_blank" rel="noreferrer"
                ...
                className="flex items-center justify-center gap-2 p-4 rounded-xl bg-pink-50 border border-pink-200 text-pink-700 font-bold text-sm hover:bg-pink-100 hover:scale-105 transition-all duration-300">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
